...
import Img1 from "../../Image/Buytickets/1716623065_ahoo-018-min.jpg"
import Img2 from "../../Image/Buytickets/Aho/mov_146927_169518.webp"
import Img3 from "../../Image/Buytickets/Aho/15.svg"
import Img4 from "../../Image/Buytickets/Aho/rvw_cast_476_402-b.webp"
import Img5 from "../../Image/Buytickets/Aho/rvw_cast_82564_9788.webp"
import Img6 from "../../Image/Buytickets/Aho/rvw_cast_1068_252-b.webp"
import Img7 from "../../Image/Buytickets/Aho/rvw_cast_670_1-b.webp"
import Img8 from "../../Image/Buytickets/Aho/rvw_cast_1327_1-b.webp"
import Img9 from "../../Image/Buytickets/Aho/rvw_cast_668_594-b.webp"
...
function Aho() {
  ...
  return (
    <>
    <div className='w-[100%] h-[1800.22px] bg-[#151515]  relative'>
        <div className='w-[100%] block'><Header/></div>
        <div className='w-[100%] h-[514.95px] relative top-[3%]  flex items-center justify-center'>
              ...
              <div className='w-[1136px] h-[320.15px]  mb-[16px] flex'>
                ...
                <div className='w-[271.86px] h-[320.15px]'>
                  <div className='w-[271.86px] h-[58.4px]'>
                    <h1 className='text-[16px] text-[#FFFFFF] font-medium '>فیلم آهو</h1>
                  </div>
                  ...
                  <span className='w-[47.81px] h-[20.4px] flex items-center pt-[2px]  bg-[#F6B828] ps-[3.5px] pe-[7px] rounded-l-3xl text-center'>
                    <span className='text-[10px] font-bold inline-block'>4.3 /10</span>
                  </span>
                  </div>
                  ...
                  <div className='w-[268.66px] h-[77.6px]'>
                    <h1 className='text-[10px] font-bold text-white mb-[16px]'>کارگردان:هوشنگ گلمکانی</h1>
                    <p className='text-[10px] font-bold text-white mb-[24px]'>یک ساعت و ۳۱ دقیقه - محصول ایران - ۱۳۹۹ - کیفیت HD
                    </p>
                  </div>
                  <div className='w-[271.86px] h-[28.6px]'>
                    ...
                    <span className='w-[61.54px] h-[28.6px] text-center rounded-3xl bg-[#4D4D4D] text-[11px] font-bold text-white py-[4px] ps-[8px] pe-[9px]'> خانوادگی</span>
                  </div>
                  </div>
                </div>
              </div>
  ...
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
        ...
        <div className='w-[1519.2px] h-[1184.47px] pt-[40px] mb-[60px] relative top-[3%] '>
          <div className='w-[1519.2] h-[174.4px] mx-[159.6px] px-[30px]'>
            <div className='w-[1200px] h-[134.4px]'>
              <div className='w-[1140px] h-[134.4px] mb-[32px]'>
                <div className='w-[1140px] h-[51.2px] mb-[32px]'>
                  <h2 className='w-[1140px] h-[23.2px] mb-[8px] text-[16px] font-bold text-white'>داستان فیلم آهو</h2>
                  <p className='w-[1140px] h-[20px] text-[#b3b3b3] text-[13px] font-bold'>آهو حکایت انزوای خودخواسته دختری است که آرزوهایش را بر باد رفته می‌بیند، اما هنوز امیدش را از دست نداده است.</p>
                </div>
                <div className='w-[1140px] h-[51.2px]'>
                  <h2 className='w-[1140px] h-[23.2px] mb-[8px] text-[16px] font-bold text-white'>درباره فیلم آهو</h2>
                  <p className='text-[#b3b3b3] text-[11px] font-bold'>فیلم آهو به کارگردانی <a href="#" className='hover:text-[#EFB73A] text-[#d9d9d9] transition duration-[.3s]'>هوشنگ گلمکانی</a> در سال 1399 ساخته شده است. این فیلم محصول کشور ایران و در ژانر <a href="#" className='hover:text-[#EFB73A] text-[#d9d9d9] transition duration-[.3s]' >درام</a> و <a href="#" className='hover:text-[#EFB73A] text-[#d9d9d9] transition duration-[.3s]'>خانوادگی</a> می‌باشد. در این فیلم علی مصفا، سپیده آرمان، حامد کمیلی، سهیلا رضوی، رضا یزدانی و رضا کیانیان به هنرمندی پرداخته‌اند.</p>
                </div>
              </div>
            </div>
          </div>
        <div className='w-[1519.2px] h-[376.275px] mb-[60px]'>
          <div className='w-[1140px] h-[376.275px] px-[30px] mx-[159.6px]'>
            <div className='w-[1140px] h-[376.275px] my-[30px]'>
         ...
         <div className='w-[1519.2px] h-[121.2px] pt-[32px] mb-[60px]'>
          <div className='w-[1200px] h-[89.2px] px-[30px] mx-[159.6px]'>
            <h2 className='w-[1140px] h-[23.2px] mb-[15px] text-[14px] font-bold text-white'>بازیگران فیلم آهو</h2>
            <div className='w-[1130px] h-[51px] ms-[10px]'>
              <div className='w-[1130px] h-[51px] text-white'>
                <div className='w-[109.49px] h-[51px] inline-block'>
                  <a href="#" className='w-[109.49px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='علی مصفا'>
                    <img src={Img4} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[52.96px] h-[23px] inline-block ms-1 font-bold'>
                      <span className='w-[52.96px] h-[20px] text-[12px]'>علی مصفا</span>
                      <span className='block w-[52.96px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
                <div className='w-[121.74px] h-[51px] inline-block'>
                  <a href="#" className='w-[121.74px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='سپیده آرمان'>
                    <img src={Img5} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[65.21px] h-[23px] inline-block ms-1 font-bold'>
                      <span className='w-[65.21px] h-[20px] text-[12px]'>سپیده آرمان</span>
                      <span className='block w-[65.21px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
                <div className='w-[120.63px] h-[51px] inline-block'>
                  <a href="#" className='w-[120.63px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='حامد کمیلی'>
                    <img src={Img6} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[64.1px] h-[23px] inline-block ms-1 font-bold'>
                      <span className='w-[64.1px] h-[20px] text-[12px]'>حامد کمیلی</span>
                      <span className='block w-[64.1px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
                <div className='w-[122.06px] h-[51px] inline-block'>
                  <a href="#" className='w-[122.06px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='سهیلا رضوی'>
                    <img src={Img7} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[65.54px] h-[23px] inline-block ms-1 font-bold'>
                      <span className='w-[65.54px] h-[20px] text-[12px]'>سهیلا رضوی</span>
                      <span className='block w-[65.54px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
                <div className='w-[114.1px] h-[51px] inline-block'>
                  <a href="#" className='w-[114.1px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='رضا یزدانی'>
                    <img src={Img8} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[57.58px] h-[23px] inline-block ms1 font-bold'>
                      <span className='w-[57.58px] h-[20px] text-[12px]'>رضا یزدانی</span>
                      <span className='block w-[57.58px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
                <div className='w-[117.36px] h-[51px] inline-block'>
                  <a href="#" className='w-[117.36px] h-[44px] py-[2px] ps-[2px] pe-[10px] mb-[7px] rounded-[40px] block bg-[rgba(255,255,255,.05)]' title='رضا کیانیان'>
                    <img src={Img9} className='w-[40px] h-[40px] p-[3px] rounded-[40px] inline' alt="" />
                    <span className='w-[60.84px] h-[23px] inline-block ms-1 font-bold'>
                      <span className='w-[60.84px] h-[20px] text-[12px]'>رضا کیانیان</span>
                      <span className='block w-[60.84px] h-[3px]'></span>
                    </span>
                  </a>
                </div>
              </div>
         ...
         <div className='w-[1519.2px] h-[112px] mb-[30px]'>
          <div className='w-[1200px] h-[112px] px-[30px] mx-[159.6px]'>
            <h2 className='w-[1140px] h-[23.2px] mb-[15px] text-white font-bold text-[14px]'>سایر عوامل فیلم آهو</h2>
            <div className='w-[1130px] h-[73.8px] ms-[10px]'>
              <ul className='w-[1130px] h-[73.8px] flex'>
                <li className='w-[74.68px] h-[43.8px] me-[30px] mb-[30px] inline-block'>
                  <h3 className='w-[74.68px] h-[20px] mb-[7px] text-[rgba(130,130,130)] text-[16px]'>کارگردان</h3>
                  <a href="#" title='هوشنگ گلمکانی' className='w-[74.68px] h-[16.8px] transition duration-[.15s] font-bold text-[11px] text-white hover:text-[#FDC13C]'>
                    هوشنگ گلمکانی
                  </a>
                </li>
                <li className='w-[68.34px] h-[43.8px] me-[30px] mb-[30px] inline-block'>
                  <h3 className='w-[68.34px] h-[20px] mb-[7px] text-[rgba(130,130,130)] text-[16px]'>تهیه کننده</h3>
                  <a href="#" title='جواد نوروزبیگی' className='w-[68.34px] h-[16.8] transition duration-[.15s] font-bold text-[11px] text-white hover:text-[#FDC13C]'>
                   جواد نوروزبیگی
                  </a>
                </li>
                <li className='w-[74.68px] h-[43.8px] me-[30px] mb-[30px] inline-block'>
                  <h3 className='w-[74.68px] h-[20px] mb-[7px] text-[rgba(130,130,130)] text-[16px]'>نویسنده</h3>
                  <a href="#" title='هوشنگ گلمکانی' className='w-[74.68px] h-[16.8] transition duration-[.15s] font-bold text-[11px] text-white hover:text-[#FDC13C]'>
                   هوشنگ گلمکانی
                  </a>
                </li>
                <li className='w-[68.36px] h-[43.8px] me-[30px] mb-[30px] inline-block'>
                  <h3 className='w-[68.36px] h-[20px] mb-[7px] text-[rgba(130,130,130)] text-[16px]'>آهنگساز</h3>
                  <a href="#" title='هوشنگ گلمکانی' className='w-[68.36px] h-[16.8] transition duration-[.15s] font-bold text-[11px] text-white hover:text-[#FDC13C]'>
                   فردین خلعتبری
                  </a>
                </li>
                ...
                <li className='w-[67.36px] h-[43.8px] me-[30px] mb-[30px] inline-block'>
                  <h3 className='w-[67.36px] h-[20px] mb-[7px] text-[rgba(130,130,130)] text-[16px]'>تدوین گر</h3>
         ...
         <div className='w-[1519.2px] h-[190.6px]' ref={itemRef}>
          <div className='w-[1200px] h-[190.6px] mx-[159.6px] px-[30px]'>
            <div className='w-[1140px] h-[190.6px]'>
              <h2 className='w-[127.04px] h-[23.2px] me-[16px] mb-[15px] font-bold text-[14px] text-white'>
                دیدگاه های فیلم آهو
              </h2>
              <div className={`w-[1140px] h-[45.6px] ps-[8px] mb-[24px] flex ${isopen?"h-[85.6px]":"h-[45.6px]"} transition-all duration-[0.2s] `}>
                ...
                <div className='w-[1090px] h-[45.6px] ms-[8px]' ref={contentRef} style={{ maxHeight: height }}>
                  <form className={`w-[1090px]  rounded-[4px] transition-all duration-[0.2s] ${isopen?"bg-white h-[80px]": "h-[40px] bg-[rgba(0,0,0,0.1)]"}`} >
                    ...
                    <button className='w-[40px] h-[40px] py-[1px] px-[6px] bg-inherit absolute right-[1287px] top-[1042px]'>
